...
function send_mail($to, $subject, $text, $html) {
	...
	$html .= "<p>This email was sent from the Troop 848 website. You can visit it <a href='http://troop-848.herokuapp.com/index.php'>here</a>. To change your email settings, login to the site and click 'Dashboard' in the upper right.</p>";
